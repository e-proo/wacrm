...
export type IntentBusinessEventType =
...
const DEFINITIONS: readonly {
  ...
  },
  {
    ...
    description:
      'A generic customer service request was matched to an available service.',
  },
  {
    key: 'service_request.needs_clarification',
    title: 'Service request needs clarification',
    description:
      'A generic customer service request requires more customer information.',
  },
  {
...
export const INTENT_BUSINESS_EVENT_MANIFESTS: readonly BusinessEventManifest[] =
