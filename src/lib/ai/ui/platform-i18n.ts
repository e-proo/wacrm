...
const TOOL_TEXT: Record<AiUiLocale, Record<string, ToolText>> = {
  en: {
    ...
    'exchange_rates.admin_list_books': { label: 'List exchange-rate books', description: 'Read exchange-rate books and their currently published versions for administration.' },
    'exchange_rates.propose_pair_change': { label: 'Propose exchange-rate change', description: 'Create an admin change request for one currency pair using expected-version protection.' },
  ...
  ar: {
    ...
    'exchange_rates.admin_list_books': { label: 'عرض دفاتر أسعار الصرف', description: 'قراءة دفاتر أسعار الصرف وإصداراتها المنشورة حاليًا للإدارة.' },
    'exchange_rates.propose_pair_change': { label: 'اقتراح تغيير سعر صرف', description: 'إنشاء طلب تغيير إداري لزوج عملات مع حماية الإصدار المتوقع.' },
