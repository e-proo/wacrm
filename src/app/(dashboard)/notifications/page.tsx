...
import { Bell, CheckCheck, ClipboardList, Loader2, UserPlus } from "lucide-react";
...
const TYPE_ICON: Record<Notification["type"], typeof Bell> = {
  ...
  customer_intent_forwarded: ClipboardList,
};
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Conversation assignments and customer requests that need review show up here.
          </p>
        </div>
        <Button
          variant="outline"
      ...
      {notifications.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/40">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            You&apos;ll see alerts here for assignments and customer requests that need review.
          </p>
        </div>
      ) : (
